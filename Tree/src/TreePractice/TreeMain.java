...
public class TreeMain {
	public static void main(String[] args) {
		Node n1 = new Node(100, null, null); Node n2 = new Node(200, null, null); // 노드생성
		...
		n1.setLeft(n2); n1.setRight(n3); // 노드연결
		...
		Node n10 = new Node(100, null, null); Node n20 = new Node(200, null, null); // 노드생성
		...
		n10.setLeft(n20); n10.setRight(n30); // 노드연결
